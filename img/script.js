$(window).load(function() {
    $("#navCategorie").css("display", 'none');
	$('#menu').css('display','none');
	$('#mutedButton').css('display','none');
...
jQuery(document).ready(function($) {
    ...
    $('.GeneralElement').css("display", 'none');
    ...
    /*****************************************************/
    /***********début de la navigation par touche************/
    /*****************************************************/
    //key left
...
//            if (currentFormationCategorie != nbrFormationCategorie){
    ...
    var page2title = "II. Formation";
    var page3title = "III. ExpÃ©rience professionel";
    var page4title = "IV. CompÃ©tence";
    var page5title = "V. A propos de moi";
    var page6title = "VI. Thanks !";
...
//        $('#arrow_previous').css('left', '0%');
    ...
    function next() {
        ...
        //si la catégorie est égal au nombre de catégories
        if (currentFormationCategorie === nbrFormationCategorie) {
    ...
    function previous() {
        ...
        console.log("catégorie :" + currentFormationCategorie);
    ...
    /**************************************************************************/
    var compteur = 1;
    var citation1 = "''Nous attendons toujours, pour nous exÃ©cuter, l'instant oÃ¹ nous sommes forcÃ©s par les circonstances.''";
    var citation2 = "''CrÃ©er, aussi, c'est donner une forme Ã  son destin.''";
    var citation3 = "''Toutes les morales sont fondÃ©es sur l'idÃ©e qu'un acte a des consÃ©quences qui le lÃ©gitiment ou l'oblitÃ¨rent.''";
